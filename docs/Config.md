...
**share** | Option<**Share**> | Control sharing behavior:'manual' allows manual sharing via commands, 'auto' enables automatic sharing, 'disabled' disables all sharing (enum: manual, auto, disabled) | [optional]
